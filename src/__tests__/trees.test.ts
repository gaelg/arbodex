...
const ARBRES_TEST: Arbre[] = [
  {
    ...
    port: "ovale",
    type_sol: "Argileux",
    résistance_sécheresse: "moyenne",
    pH: "basique",
    tolerance_sel: "oui",
    rusticite_min_C: -30,
    résistance_vent: 4,
    résistance_chaleur_urbaine: 4,
  ...
  },
  {
    ...
    résistance_sécheresse: "faible",
    pH: "acide",
    tolerance_sel: "non",
    rusticite_min_C: -35,
    résistance_vent: 3,
    résistance_chaleur_urbaine: 3,
  ...
  },
  {
    ...
    résistance_sécheresse: "excellente",
    pH: "neutre",
    tolerance_sel: "oui",
    rusticite_min_C: -25,
    résistance_vent: 4,
    résistance_chaleur_urbaine: 5,
    adapte_changement_climatique: "oui",
    mellifere: "non",
    fruitière_sauvage: "oui",
    refuge_oiseaux: "oui",
...
describe("appliquerFiltres", () => {
  ...
  it("filtre par résistance vent minimum", () => {
    const filtres: Filtres = { ...filtresVides, résistance_vent: "4" };
    const resultat = appliquerFiltres(ARBRES_TEST, filtres);
    expect(resultat).toHaveLength(2);
    expect(resultat.map((a) => a.nom_commun)).toContain("Chêne pédonculé");
    expect(resultat.map((a) => a.nom_commun)).toContain("Ginkgo");
